...
parser = argparse.ArgumentParser(description='KoBART fine-tuning')
...
if __name__ == '__main__':
    wandb.login(key="356baba1edeae8f209f108654f297c4f0c4855fc")
    ...
    wandb_logger = WandbLogger(project="KoBART-fine")
